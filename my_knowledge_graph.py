...
class MyKnowledgeGraph:
    ...
    def _init(self, dataset):
        # Load entities
        entity_file ='../../data/ml1m/preprocessed/cafe/kg_entities.txt.gz'
        ...
        # Load relations
        relation_file = '../../data/ml1m/preprocessed/cafe/kg_relations.txt.gz'
        id2rel = {}
        ...
        # Load triples
        triple_file = '../../data/ml1m/preprocessed/cafe/kg_triples.txt.gz'
        num_triples = 0
        invalid = 0
        ...
        # Load rules
        rule_file = "../../data/ml1m/preprocessed/cafe/kg_rules.txt.gz"
