...
from symbolic_model_diversity import EntityEmbeddingModel, SymbolicNetwork, create_symbolic_model, load_diversity_scores
...
def train(args):
    ...
    # Load diversity scores
    diversity_scores = load_diversity_scores('C:/Users/utkid/Prediss_Chest/Hands-On/data/ml1m/preprocessed/cafe/tmp/diversity_scores_1.csv')
    #updated here added an underscore
    model, _ = create_symbolic_model(args, dataloader.kg, train=True, pretrain_embeds=kg_embeds)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        while dataloader.has_next():
            ...
            reg_loss = reg_loss.mean()  # Ensure reg_loss is a scalar
            rank_loss = rank_loss.mean()  # Ensure rank_loss is a scalar
